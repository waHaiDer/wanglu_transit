// server_part2.c — Multi-client chat server (limit=2, say "Server is full!" to 3rd)
// Build: gcc -O2 -Wall -Wextra -o server_part2 server_part2.c -lpthread
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
int main(void) {
    ...
    printf("Server (part2) listening on %d...\n", PORT);
